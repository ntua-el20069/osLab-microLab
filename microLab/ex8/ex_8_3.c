...
sprintf(payload, "ESP:payload:[{\"name\":\"temperature\",\"value\":\"%d.%d\"},{\"name\":\"pressure\",\"value\":\"%d.%d\"},{\"name\":\"team\",\"value\":\"51\"},{\"name\":\"status\",\"value\":\"%s\"}]", (int)temperature, (int)((temperature-(int)temperature)*1000),(int)pressure,(int)((pressure-(int)pressure)*1000),stat);
